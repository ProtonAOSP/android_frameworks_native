...
string BlurFilter::getMixFragShader() const {
    return R"SHADER(
        ...
        float remapUniformToTriangular(float rnd)
        {
    rnd = fract(rnd + 0.5f);
    ...
    return rnd;
        ...
        void main() {
            ...
            // Remap [0, 1] noise to to triangular [0, 1]
            noise = vec3(remapUniformToTriangular(noise.r), remapUniformToTriangular(noise.g), remapUniformToTriangular(noise.b));
