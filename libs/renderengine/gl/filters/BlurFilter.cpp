...
BlurFilter::BlurFilter(GLESRenderEngine& engine)
    ...
    mMBlueNoiseLoc = mMixProgram.getUniformLocation("kBlueNoise");
...
status_t BlurFilter::render(bool /*multiPass*/) {
    ...
    glUniform1fv(mMBlueNoiseLoc, 256, v);
